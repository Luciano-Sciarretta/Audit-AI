...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                #context_processors propios:
                'inbox.context_processors.inbox_unread_count'
            ],
        },
    },
]
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'lucianosciarretta27@gmail.com ' 
EMAIL_HOST_PASSWORD = 'sicx ueay ltte upes'